package org.mediqueue.backend.security;

import org.mediqueue.backend.utils.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/medi-queue/user/**").hasRole("USER")
    ...
    // <<< ADD THIS BEAN TO PROVIDE AuthenticationManager >>>
    @Bean
